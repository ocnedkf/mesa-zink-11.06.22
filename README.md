...
<br>
apt update && apt -y install python3-pip python3-mako cmake zlib1g-dev bison flex pkg-config libx11-dev libxext-dev libxcb-randr0-dev libxrandr-dev libdrm-dev libdrm2 git ninja-build
<br>
pip3 install meson
<br>
